													...
													<div class="card-tools">
														<div class="input-group input-group-sm float-right">
															...
															<div class="input-group-btn">
																<button type="submit" class="btn btn-secondary" onclick="$('#'+'mainform').attr('action', '<?=site_url("menu/search/$tip")?>');$('#'+'mainform').submit();"><i class="fa fa-search"></i></button>
															</div>
														</div>
													</div>
												</div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="dataTables_length">
                          <form id="paging" action="<?= site_url("menu")?>" method="post" class="">
                            <label>
                              Tampilkan
