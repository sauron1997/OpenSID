<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="" id="validasi" name="form_tanah" method="post" action="<?= site_url("api_inventaris_tanah/add"); ?>">
			<div class="row">
				<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="col-sm-3 col-form-label" style="text-align:left;" for="nama_barang">Nama Barang</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label" style="text-align:left;" for="tahun">Tahun Pengadaan </label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label" style="text-align:left;" for="alamat">Letak / Alamat </label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label required" style="text-align:left;" for="hak_tanah">Hak Tanah </label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label required" style="text-align:left;" for="tanggal_sertifikat">Tanggal Sertifikat</label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label" style="text-align:left;" for="no_sertifikat">Nomor Sertifikat </label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label required" style="text-align:left;" for="penggunaan">Penggunaan </label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label required" style="text-align:left;" for="asal">Asal Usul </label>
									<div class="col-sm-4">
