							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="col-sm-3 col-form-label required" style="text-align:left;" for="nama_barang">Nama Barang</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label required" style="text-align:left;" for="nomor_sertifikat">Nomor Sertifikat </label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label required" style="text-align:left;" for="asal_usul">Asal Usul </label>
										<div class="col-sm-4">
