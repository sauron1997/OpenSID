<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="" id="validasi" name="form_mutasi_jalan" method="post" action="<?= site_url("api_inventaris_jalan/update_mutasi"); ?>">
			<div class="row">
				<div class="col-md-3">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="mutasi">Jenis Mutasi </label>
										<div class="col-sm-4">
