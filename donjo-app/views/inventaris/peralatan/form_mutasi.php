<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="" id="validasi" name="form_mutasi_peralatan" method="post" action="<?= site_url("api_inventaris_peralatan/add_mutasi"); ?>">
			<div class="row">
				<div class="col-md-3">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="mutasi" require>Jenis Mutasi </label>
										<div class="col-sm-4">
									...
									<div class="form-group disumbangkan">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="sumbangkan">Disumbangkan ke-</label>
										<div class="col-sm-8">
									...
									<div class="form-group harga_jual">
										<label class="col-sm-3 col-form-label " style="text-align:left;" for="harga_jual">Harga Penjualan</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label required" style="text-align:left;" for="tahun_mutasi">Tahun Mutasi</label>
										<div class="col-sm-4">
