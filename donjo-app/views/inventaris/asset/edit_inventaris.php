...
<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="" id="validasi" name="form_asset" method="post" action="<?= site_url("api_inventaris_asset/update/$main->id"); ?>">
			<div class="row">
				<div class="col-md-3">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="jenis_asset">Jenis Asset</label>
										<div class="col-sm-4">
									...
									<div class="form-group judul">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="judul">Judul dan Pencipta Buku</label>
										<div class="col-sm-8">
											<input class="form-control input-sm" value="<?= $main->judul_buku; ?>" id="judul" name="judul" type="text"/>
										</div>
									</div>
									<div class="form-group spesifikasi">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="spesifikasi">Spesifikasi Buku</label>
										<div class="col-sm-8">
									...
									<div class="form-group asal_kesenian">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="asal_kesenian">Asal Daerah Kesenian</label>
										<div class="col-sm-8">
									...
									<div class="form-group pencipta_kesenian">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="pencipta_kesenian">Pencipta Kesenian </label>
										<div class="col-sm-8">
									...
									<div class="form-group bahan_kesenian">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="bahan_kesenian">Bahan Kesenian</label>
										<div class="col-sm-8">
									...
									<div class="form-group jenis_hewan">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="jenis_hewan">Jenis Hewan Ternak</label>
										<div class="col-sm-8">
									...
									<div class="form-group ukuran_hewan">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="ukuran_hewan">Ukuran Hewan Ternak</label>
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control input-sm number" value="<?= $main->ukuran_hewan; ?>" id="ukuran_hewan" name="ukuran_hewan" type="text"/>
												<span class="input-group-text input-sm" id="ukuran_hewan-addon">Kg</span>
											</div>
										</div>
									</div>
									<div class="form-group jenis_tumbuhan">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="jenis_tumbuhan">Jenis Tumbuhan</label>
										<div class="col-sm-8">
									...
									<div class="form-group ukuran_tumbuhan">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="ukuran_tumbuhan">Ukuran Tumbuhan</label>
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control input-sm number" value="<?= $main->ukuran_tumbuhan; ?>" id="ukuran_tumbuhan" name="ukuran_tumbuhan" type="text"/>
												<span class="input-group-text input-sm" id="ukuran_tumbuhan">M</span>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="jumlah">Jumlah</label>
										<div class="col-sm-8">
											<input class="form-control input-sm number" value="<?= $main->jumlah; ?>" id="jumlah" name="jumlah" type="text"/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="tahun">Tahun Pembelian </label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label required" style="text-align:left;" for="hak_tanah">Penggunaan Barang </label>
										<div class="col-sm-4">
