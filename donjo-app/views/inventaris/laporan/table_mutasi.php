																...
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_tanah/mutasi'); ?>" title="Lihat Data" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_peralatan/mutasi'); ?>" title="Lihat Data" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_gedung/mutasi'); ?>" title="Lihat Data" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_jalan/'.$data->id.'/mutasi'); ?>" title="Lihat Data" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_asset/mutasi'); ?>" title="Lihat Data" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_kontruksi/mutasi'); ?>" title="Lihat Data" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
															</tbody>
