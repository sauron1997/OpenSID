...
<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="" id="validasi" name="form_gedung" method="post" action="<?= site_url("api_inventaris_gedung/update/$main->id"); ?>">
			<div class="row">
				<div class="col-md-3">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="tingkat">Bangunan Bertingkat</label>
										<div class="col-sm-4">
											<div class="input-group">
												...
												<span class="input-group-text input-sm" id="koefisien_dasar_bangunan-addon">Lantai</span>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="kontruksi">Kontruksi Beton</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="luas_bangunan">Luas Bangunan</label>
										<div class="col-sm-4">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="tahun_pengadaan">Tahun Pembelian</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="no_bangunan">Nomor Bangunan</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="tanggal_bangunan">Tanggal Dokumen Bangunan</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="status_gedung">Status Tanah</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="luas_tanah">Luas Tanah </label>
										<div class="col-sm-4">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="col-sm-3 col-form-label" style="text-align:left;" for="asal">Asal Usul </label>
										<div class="col-sm-4">
