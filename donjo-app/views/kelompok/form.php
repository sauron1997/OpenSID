				...
				<div class="card card-info">
					...
					<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="">
						<div class="card-body">
							...
							<div class="form-group">
								<label  class="col-sm-3 col-form-label" for="id_ketua">Ketua Kelompok</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label  class="col-sm-3 col-form-label" for="keterangan">Deskripsi Kelompok</label>
								<div class="col-sm-7">
