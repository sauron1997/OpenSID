<style type="text/css">
	label.col-form-label.text-left { text-align: left }
	label.col-form-label.no-padding-top { padding-top: 0px }
</style>
				...
				<div class="card card-info">
					<div class="card-body">
						<div class="card-header with-border">
							<a href="<?= site_url('program_bantuan')?>" class="btn btn-social btn-flat btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Program Bantuan"><i class="fa far fa-arrow-alt-circle-left"></i> Kembali Ke Daftar Program Bantuan</a>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="card-header with-border">
											<h3 class="card-title">Tambah Peserta Program</h3>
										</div>
                     <div class="card-body">
                       <form action="" id="main" name="main" method="POST"  class="">
												<div class="form-group" >
									  			<label class="col-sm-4 col-lg-2 col-form-label <?php ($detail['sasaran'] != 1) and print('no-padding-top') ?>" for="nik"><?= $detail['judul_cari_peserta']?></label>
													<div class="col-sm-7">
                      ...
                      <form id="validasi" action="<?= $form_action?>/<?= $detail['id']?>" method="POST" enctype="multipart/form-data" class="">
												<input type="hidden" name="nik" value="<?= $individu['nik']?>"  >
												<div class="form-group">
													<label for="kartu_nik" class="col-sm-11 col-form-label text-left">IDENTITAS PADA KARTU PESERTA</label>
												</div>
												<div class="form-group">
													<label for="no_id_kartu" class="col-sm-4 col-lg-2  col-form-label">Nomor Kartu Peserta</label>
													<div class="col-sm-7">
								  					<input  id="no_id_kartu" class="form-control input-sm" type="text" placeholder="Nomor Kartu Peserta" name="no_id_kartu" required="" >
													</div>
												</div>
												<div class="form-group">
													<label for="jenis_keramaian"  class="col-sm-4 col-lg-2 col-form-label">Gambar Kartu Peserta</label>
													<div class="col-sm-7">
												...
												<div class="form-group">
										  		<label for="kartu_tanggal_lahir"  class="col-sm-4 col-lg-2 col-form-label">Tanggal Lahir</label>
													<div class="col-sm-7">
														<div class="input-group input-group-sm date">
															<div class="input-group-text">
																<i class="fa fa-calendar"></i>
															</div>
															<input class="form-control input-sm float-right" id="tgl_1" name="kartu_tanggal_lahir" placeholder="Tgl. Lahir" type="text" value="<?= tgl_indo_out($individu['tanggallahir'])?>">
														</div>
													</div>
												</div>
												<div class="form-group">
													<label for="kartu_alamat"  class="col-sm-4 col-lg-2 col-form-label">Alamat</label>
													<div class="col-sm-7">
