							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control input-sm float-right required" id="tgl_1" name="sdate" placeholder="Tgl. Mulai" type="text">
									</div>
								</div>
								<div class="col-sm-4">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control input-sm float-right required" id="tgl_2" name="edate" placeholder="Tgl. Akhir" type="text">
									</div>
								</div>
			             	</div>
			             	<div class="form-group">
