			...
			<div class="col-sm-12">
				<div class="card-body">
					<div class="form-group">
						<label class="col-form-label" for="nama">Klasifikasi</label>
					...
					<div class="form-group">
						<label class="col-form-label" for="minval">Nilai Minimal</label>
					...
					<div class="form-group">
						<label class="col-form-label" for="minval">Nilai Maksimal</label>
