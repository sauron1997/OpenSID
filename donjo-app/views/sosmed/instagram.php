							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label class="col-sm-3 col-form-label">Link Akun Instagram</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										...
										<div class="btn-group col-12 col-sm-9" data-toggle="buttons">
											<label id="sx3" class="btn btn-info btn-flat btn-sm col-6 col-sm-4 col-lg-2 form-check-label <?php if ($main['enabled'] =='1'): ?>active<?php endif ?>">
											...
											<label id="sx4" class="btn btn-info btn-flat btn-sm col-6 col-sm-4 col-lg-2 form-check-label <?php if ($main['enabled'] =='2'): ?>active<?php endif ?>">
