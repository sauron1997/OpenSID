								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="mailbox-attachment-info">
											...
											<p><label class="col-form-label"><input type="checkbox" name="gambar_hapus" value="<?=  $surat_keluar['berkas_scan']?>" /> Hapus Berkas Lama</label></p>
										</div>
									</div>
								</div>
							<?php endif; ?>
							<div class="form-group">
								<label class="col-sm-3 col-form-label" for="kode_pos">Berkas Scan Surat Keluar</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-lg-4">
									<div class="input-group input-group-sm date">
										...
										<input class="form-control input-sm float-right required" id="tgl_2" name="tanggal_surat" type="text" value="<?= tgl_indo_out($surat_keluar['tanggal_surat'])?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 col-form-label" for="pengirim">Tujuan</label>
								<div class="col-sm-8">
