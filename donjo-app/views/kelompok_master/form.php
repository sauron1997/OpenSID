					...
					<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="">
						<div class="card-body">
							<div class="form-group">
								<label class="col-sm-3 col-form-label" for="nama">Klasifikasi/Kategori Kelompok</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-3 col-form-label" for="Deskripsi">Deskripsi Kelompok</label>
								<div class="col-sm-8">
