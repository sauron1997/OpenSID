            ...
            <div class="card-header with-border">
						...
						<div class="card-body">
							<div class="form-group">
								<label class="col-form-label col-sm-3">Nama Lokasi / Properti</label>
								<div class="col-sm-7">
							...
							<?php endif; ?>
							<div class="form-group">
								<label class="col-form-label col-sm-3">Ganti Foto</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-12 col-sm-3 col-lg-3 col-form-label" for="status">Status</label>
								<div class="btn-group col-12 col-sm-9" data-toggle="buttons">
									<label id="sx3" class="btn btn-info btn-flat btn-sm col-6 col-sm-4 col-lg-2 form-check-label <?php if ($lokasi['enabled'] =='1' OR $lokasi['enabled'] == NULL): ?>active<?php endif ?>">
									...
									<label id="sx4" class="btn btn-info btn-flat btn-sm col-6 col-sm-4 col-lg-2 form-check-label <?php if ($lokasi['enabled'] == '2' ): ?>active<?php endif ?>">
