									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label class="col-sm-3 col-form-label" for="id_tipe">Tipe Pertanyaan</label>
												<div class="btn-group col-12 col-sm-8" data-toggle="buttons">
													<label id="sx3" <?php if ($analisis_master['jenis']==1): ?>disabled="disabled"<?php endif; ?> class="btn btn-info btn-flat btn-sm col-12 col-sm-6 col-lg-3 form-check-label <?php if ($analisis_indikator['id_tipe'] =='1' OR $analisis_indikator['id_tipe'] == NULL): ?>active<?php endif ?>">
													...
													<label id="sx2" <?php if ($analisis_master['jenis']==1): ?>disabled="disabled"<?php endif; ?> class="btn btn-info btn-flat btn-sm col-12 col-sm-6 col-lg-3 form-check-label <?php if ($analisis_indikator['id_tipe'] =='2'): ?>active<?php endif ?>">
													...
													<label id="sx1" <?php if ($analisis_master['jenis']==1): ?>disabled="disabled"<?php endif; ?> class="btn btn-info btn-flat btn-sm col-12 col-sm-6 col-lg-3 form-check-label <?php if ($analisis_indikator['id_tipe'] =='3'): ?>active<?php endif ?>">
													...
													<label id="sx4" <?php if ($analisis_master['jenis']==1): ?>disabled="disabled"<?php endif; ?> class="btn btn-info btn-flat btn-sm col-12 col-sm-6 col-lg-3 form-check-label <?php if ($analisis_indikator['id_tipe'] =='4'): ?>active<?php endif ?>">
										...
										<div class="col-sm-12">
											<div class="form-group">
												<label class="col-sm-3 col-form-label" for="nomor">Kode Pertanyaan</label>
												<div class="col-sm-2">
										...
										<div class="col-sm-12">
											<div class="form-group" id="delik">
												<label class="col-sm-3 col-form-label" for="pertanyaan">Pertanyaan</label>
												<div class="col-sm-8">
										...
										<div class="col-sm-12">
											<div class="form-group">
												<label class="col-sm-3 col-form-label" for="id_tipe">Kategori Indikator</label>
												<div class="col-sm-5">
										...
										<div class="col-sm-12 hide">
											<div class="form-group" id="delik">
												<label class="col-sm-3 col-form-label" for="bobot">Bobot</label>
												<div class="col-sm-2">
										...
										<div class="col-sm-12">
											<div class="form-group" id="delik">
												<label class="col-sm-3 col-form-label" for="act_analisis">Publikasi Indikator</label>
												<div class="btn-group col-sm-7" data-toggle="buttons">
													<label id="ss1" class="btn btn-info btn-flat btn-sm col-6 col-sm-4 col-lg-2 form-check-label <?php if ($analisis_indikator['is_publik'] =='1'): ?>active<?php endif ?>">
													...
													<label id="ss2" class="btn btn-info btn-flat btn-sm col-6 col-sm-4 col-lg-2 form-check-label <?php if ($analisis_indikator['is_publik'] == '0' OR $analisis_indikator['is_publik'] ==NULL): ?>active<?php endif ?>">
