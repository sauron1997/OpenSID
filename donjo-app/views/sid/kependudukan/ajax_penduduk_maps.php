					...
					<form id="validasi1" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="">
						...
						<div class='card-footer'>
							<div class='col-12'>
								...
								<div class="form-group">
									<label class="col-sm-3 col-form-label" for="lng">Longitude</label>
									<div class="col-sm-9">
										<?php switch ($edit): ?><?php case '0': ?>
								...
								<?php switch ($edit): ?><?php case '0': ?>
									<a href="<?=site_url("penduduk")?>" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali"><i class="fa far fa-arrow-alt-circle-left"></i> Kembali</a>
									...
									<?php break; ?>
								<?php case '1': ?>
									<a href="<?=site_url("penduduk/form/$p/$o/$id/1")?>" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali"><i class="fa far fa-arrow-alt-circle-left"></i> Kembali</a>
									...
									<?php if ($penduduk['status_dasar'] == 1 || !isset($penduduk['status_dasar'])): ?>
										<button type='submit' class='btn btn-social btn-flat btn-info btn-sm float-right' id="simpan_penduduk"><i class='fa fa-check'></i> Simpan</button>
									<?php endif; ?>
									<?php break; ?>
								<?php case '2': ?>
									<a href="<?=site_url("penduduk")?>" class="btn btn-social btn-flat bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali"><i class="fa far fa-arrow-alt-circle-left"></i> Kembali</a>
