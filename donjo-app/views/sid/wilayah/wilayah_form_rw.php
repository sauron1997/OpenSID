										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													<label class="col-sm-3 col-form-label" for="rw">Nama RW</label>
													<div class="col-sm-7">
											...
											<?php if ($rw): ?>
												<div class="col-sm-12">
													<div class="form-group">
														<label class="col-sm-3 col-form-label" for="kepala_lama">Kepala RW Sebelumnya</label>
														<div class="col-sm-7">
											...
											<div class="col-sm-12">
												<div class="form-group">
													<label class="col-sm-3 col-form-label" for="id_kepala">NIK / Nama Kepala RW</label>
													<div class="col-sm-7">
