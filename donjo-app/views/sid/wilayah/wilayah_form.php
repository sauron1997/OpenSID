										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
													<label class="col-sm-3 col-form-label" for="dusun">Nama  <?= ucwords($this->setting->sebutan_dusun)?></label>
													<div class="col-sm-7">
											...
											<?php if ($dusun): ?>
												<div class="col-sm-12">
													<div class="form-group">
														<label class="col-sm-3 col-form-label" for="kepala_lama">Kepala  <?= ucwords($this->setting->sebutan_dusun)?> Sebelumnya</label>
														<div class="col-sm-7">
											...
											<div class="col-sm-12">
												<div class="form-group">
													<label class="col-sm-3 col-form-label" for="id_kepala">NIK / Nama Kepala  <?= ucwords($this->setting->sebutan_dusun)?></label>
													<div class="col-sm-7">
