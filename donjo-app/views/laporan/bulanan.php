<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form id="mainform" name="mainform" action="<?= site_url('laporan')?>" method="post" class="">
			<div class="row">
				<div class="col-md-12">
            ...
            <div class="card-header with-border">
                  ...
                  <br/>
                    ...
                    <label class="col-sm-2 col-form-label" for="kelurahan"><?= ucwords($this->setting->sebutan_desa)?>/Kelurahan</label>
                    <div class="col-sm-7 col-md-5">
                      <input type="text" class="form-control input-sm" value="<?= $config['nama_desa']?>" disabled/></input>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-form-label" for="kecamatan"><?= ucwords($this->setting->sebutan_kecamatan)?></label>
                    <div class="col-sm-7 col-md-5">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <input name="tahun" placeholder="Tahun" type="text" class="form-control input-sm required" value="<?= $tahun ?>"  onkeypress="if (event.keyCode == 13){$('#'+'mainform').attr('action', '<?=site_url("laporan/bulan")?>');$('#'+'mainform').submit();}" /></input>
										...
										<label class="col-sm-2 col-md-1 col-form-label" for="tahun">Bulan</label>
