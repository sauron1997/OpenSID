...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<form id="mainform" name="mainform" action="<?= site_url('laporan/bulan')?>" method="post" class="">
					<div class="card card-info">
						...
						<div class="card-header  with-border">
							<div class="form-group">
								<label class="col-sm-2 col-md-1 col-form-label" for="kelurahan"><?= ucwords($this->setting->sebutan_desa)?>/Kel</label>
								<div class="col-sm-4 col-md-2">
									<input type="text" class="form-control input-sm" value="<?= $config['nama_desa']?>" disabled/></input>
								</div>
								<label class="col-sm-2 col-md-1 col-form-label" for="kecamatan"><?= ucwords($this->setting->sebutan_kecamatan)?></label>
								<div class="col-sm-4 col-md-2">
									<input type="text" class="form-control input-sm" value="<?= $config['nama_kecamatan']?>" disabled/></input>
								</div>
								<?php $bln = date("m");?>
								<label class="col-sm-2 col-md-2 col-form-label" for="laporan">Lap. Bulan</label>
								<div class="col-sm-4 col-md-1">
									<input type="text" class="form-control input-sm" value="<?= $bln?>" disabled/></input>
								</div>
								<label class="col-sm-2 col-md-1 col-form-label" for="filter"><?= ucwords($this->setting->sebutan_dusun)?></label>
								<div class="col-sm-4 col-md-2">
