...
<div class="card-body">
	<div class="box-group" id="accordion">
		<div class="panel box card-default">
			<div class="card-header with-border">
				<h4 class="card-title">
		...
		<div class="panel box card-default">
			...
			<div id="collapse3" class="collapse collapse">
				<div class="card-body">
		...
		<div class="panel box card-default">
			...
			<div id="collapse4" class="collapse collapse">
				<div class="card-body">
		...
		<div class="panel box card-default">
			...
			<div id="collapse5" class="collapse collapse">
				<div class="card-body">
		...
		<div class="panel box card-default">
			...
			<div id="collapse6" class="collapse collapse">
				<div class="card-body">
					<ol>
		...
		<div class="panel box card-default">
			...
			<div id="donasi" class="collapse collapse">
				<div class="card-body">
