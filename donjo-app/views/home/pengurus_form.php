			...
			<div class="col-sm-12">
				<div class="card card-info">
					<div class="card-header with-border">
						<a href="<?= site_url()?>pengurus" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa far fa-arrow-alt-circle-left"></i> Kembali Ke Daftar Staf</a>
					</div>
					<div class="card-body">
						<div class="form-group col-sm-12 ">
							<label class="col-sm-4 col-lg-2 col-form-label kiri" for="status">DATA STAF</label>
						...
						<form action="" id="main" name="main" method="POST"  class="">
							<div class="form-group col-sm-12" >
				  			<label class="col-sm-4 col-lg-2 col-form-label" for="id_pend">NIK / Nama Penduduk </label>
								<div class="col-sm-7">
					...
					<div class="card card-primary">
						<div class="card-body">
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_nama">Nama Pegawai <?= ucwords($this->setting->sebutan_desa)?></label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_nik">Nomor Induk Kependudukan</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_niap">NIAP</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_nip">NIP</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_tempatlahir">Tempat Lahir</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_tanggallahir">Tanggal Lahir</label>
								<div class="col-sm-7">
									...
									<div class="input-group input-group-sm date pengurus-luar-desa" style="display: none;">
										...
										<input class="form-control input-sm float-right tgl_1" name="pamong_tanggallahir" type="text" value="<?= tgl_indo_out($pamong['pamong_tanggallahir'])?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_sex">Jenis Kelamin</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_pendidikan">Pendidikan</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_agama">Agama</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_pangkat">Pangkat / Golongan</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_nosk">Nomor SK Pengangkatan</label>
								<div class="col-sm-7">
							...
							<div class='form-group'>
								<label class="col-sm-4 col-form-label" for="pamong_tglsk">Tanggal SK Pengangkatan</label>
								<div class="col-sm-7">
									<div class="input-group input-group-sm date">
										<div class="input-group-text">
											<i class="fa fa-calendar"></i>
										</div>
										<input class="form-control input-sm float-right tgl_1" name="pamong_tglsk" type="text" value="<?= tgl_indo_out($pamong['pamong_tglsk'])?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_nohenti">Nomor SK Pemberhentian</label>
								<div class="col-sm-7">
							...
							<div class='form-group'>
								<label class="col-sm-4 col-form-label" for="pamong_tglhenti">Tanggal SK Pemberhentian</label>
								<div class="col-sm-7">
									<div class="input-group input-group-sm date">
										<div class="input-group-text">
											<i class="fa fa-calendar"></i>
										</div>
										<input class="form-control input-sm float-right tgl_1" name="pamong_tglhenti" type="text" value="<?= tgl_indo_out($pamong['pamong_tglhenti'])?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 col-form-label" for="pamong_masajab">Masa Jabatan (Usia/Periode)</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label class="col-12 col-sm-4 col-lg-4 col-form-label" for="status">Status Pegawai Desa</label>
								<div class="btn-group col-12 col-sm-8" data-toggle="buttons">
									<label id="sx3" class="btn btn-info btn-flat btn-sm col-6 col-sm-5 col-lg-3 form-check-label <?php if ($pamong['pamong_status'] == '1' OR $pamong['pamong_status'] == NULL): ?>active<?php endif ?>">
									...
									<label id="sx4" class="btn btn-info btn-flat btn-sm col-6 col-sm-5 col-lg-3 form-check-label <?php if ($pamong['pamong_status'] == '2'): ?>active<?php endif ?>">
