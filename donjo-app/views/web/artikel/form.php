            	...
            	<?php endif; ?>
						...
						<div class="card-body">
			  			<div class="form-group">
								<label class="col-form-label" for="judul">Judul Artikel</label>
							...
							<div class="form-group">
								<label class="col-form-label" for="kode_desa">Isi Artikel</label>
        ...
        <div class="col-md-4">
              ...
              <div class="col-sm-12">
					          ...
					          <input type="hidden" name="old_gambar" value="<?= $artikel['gambar']?>">
									  ...
									  <p class="text-center"><label class="col-form-label"><input type="checkbox" name="gambar_hapus" value="<?= $artikel['gambar']?>" /> Hapus Gambar</label></p>
									<?php else: ?>
										<img class="profile-user-img img-responsive img-circle" src="<?= base_url()?>assets/files/logo/home.png" alt="Tidak Ada Gambar">
									<?php endif; ?>
									<label class="col-form-label" for="gambar">Gambar Utama</label>
              ...
              <div class="col-sm-12">
					          ...
					          <input type="hidden" name="old_gambar1" value="<?= $artikel['gambar1']?>">
									  ...
									  <p class="text-center"><label class="col-form-label"><input type="checkbox" name="gambar1_hapus" value="<?= $artikel['gambar1']?>" /> Hapus Gambar</label></p>
									<?php else: ?>
										<img class="profile-user-img img-responsive img-circle" src="<?= base_url()?>assets/files/logo/home.png" alt="Tidak Ada Gambar">
									<?php endif; ?>
									<label class="col-form-label" for="gambar1">Gambar Tambahan</label>
									<div class="input-group input-group-sm">
							...
							<div class="col-sm-12">
					          ...
					          <input type="hidden" name="old_gambar2" value="<?= $artikel['gambar2']?>">
									  ...
									  <p class="text-center"><label class="col-form-label"><input type="checkbox" name="gambar2_hapus" value="<?= $artikel['gambar2']?>" /> Hapus Gambar</label></p>
									<?php else: ?>
										<img class="profile-user-img img-responsive img-circle" src="<?= base_url()?>assets/files/logo/home.png" alt="Tidak Ada Gambar">
									<?php endif; ?>
									<label class="col-form-label" for="gambar2">Gambar Tambahan</label>
									<div class="input-group input-group-sm">
							...
							<div class="col-sm-12">
					          ...
					          <input type="hidden" name="old_gambar3" value="<?= $artikel['gambar3']?>">
									  ...
									  <p class="text-center"><label class="col-form-label"><input type="checkbox" name="gambar3_hapus" value="<?= $artikel['gambar3']?>" /> Hapus Gambar</label></p>
									<?php else: ?>
										<img class="profile-user-img img-responsive img-circle" src="<?= base_url()?>assets/files/logo/home.png" alt="Tidak Ada Gambar">
									<?php endif; ?>
									<label class="col-form-label" for="gambar3">Gambar Tambahan</label>
									<div class="input-group input-group-sm">
					...
					<?php if ($cat == 1000): ?>
						...
						<div class="card card-info">
							...
							<div class="card-body no-padding">
								<div class="col-sm-12">
									<div class="form-group">
										<label class="col-form-label" for="tgl_agenda">Tanggal Kegiatan</label>
										<div class="input-group input-group-sm date">
											<div class="input-group-text">
												<i class="fa fa-calendar-check-o"></i>
											</div>
											<input class="form-control input-sm float-right tgl_jam" name="tgl_agenda" type="text" value="<?= $artikel['tgl_agenda']?>">
										</div>
										<span class="help-block"><code>(Isikan Tanggal Kegiatan)</code></span>
										<label class="col-form-label" for="lokasi_kegiatan">Lokasi Kegiatan</label>
										<div class="input-group input-group-sm">
											<div class="input-group-text">
												<i class="fa fa-map-marker"></i>
											</div>
											<input class="form-control input-sm float-right" name="lokasi_kegiatan" type="text" placeholder="Masukan lokasi tempat dilakukan kegiatan" value="<?= $artikel['lokasi_kegiatan']?>">
										</div>
										<span class="help-block"><code>(Isikan Lokasi Tempat Dilakukan Kegiatan)</code></span>
										<label class="col-form-label" for="koordinator_kegiatan">Koordinator Kegiatan</label>
										<div class="input-group input-group-sm">
											<div class="input-group-text">
												<i class="fa fa-user"></i>
											</div>
											<input class="form-control input-sm float-right" name="koordinator_kegiatan" type="text" placeholder="Masukan nama koordinator" value="<?= $artikel['koordinator_kegiatan']?>">
										</div>
					...
					<div class="card card-info">
						...
						<div class="card-body no-padding">
							<div class="col-sm-12">
								...
								<?php endif; ?>
				  			<div class="form-group">
									<label class="col-form-label" for="dokumen">Dokumen Lampiran</label>
									<div class="input-group input-group-sm">
								...
								<div class="form-group">
									<label class="col-form-label" for="nama_dokumen">Nama Dokumen</label>
								...
								<div class="form-group">
									<label class="col-form-label" for="tgl_upload">Tanggal Posting</label>
									<div class="input-group input-group-sm date">
										<div class="input-group-text">
											<i class="fa fa-calendar"></i>
										</div>
										<input class="form-control input-sm float-right tgl_jam" name="tgl_upload" type="text" value="<?= $artikel['tgl_upload']?>">
									</div>
